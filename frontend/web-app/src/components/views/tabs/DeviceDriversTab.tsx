    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">Treiber für Netzwerkadapter, Grafikkarten, USB-Geräte und mehr</p>
        </div>
            ...
            <div key={driver.id} className="flex items-center gap-4 px-4 py-3 hover:bg-gray-50 transition-colors">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                  ...
                  {driver.deviceType && (
                    <span className="px-1.5 py-0.5 text-xs rounded bg-slate-100 text-slate-700 font-medium">
                      {driver.deviceType}
                    </span>
                  )}
                  {driver.format && (
                  ...
                  {driver.architecture && (
                    <span className="text-xs text-gray-400">{driver.architecture}</span>
                  )}
                  {driver.source && (
