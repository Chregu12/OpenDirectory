...
for db in identity auth policy audit integration printers network api devices api_gateway app_store oauth certs mdm samba least_privilege monitoring; do
