...
class HealthCheckMiddleware {
  constructor() {
    ...
    this.services = [
      { name: 'authentication-service', url: 'http://authentication-service/health', critical: true },
      { name: 'configuration-service', url: 'http://configuration-service/health', critical: true },
      { name: 'device-service', url: 'http://device-service/health', critical: false },
      { name: 'policy-service', url: 'http://policy-service/health', critical: false },
      { name: 'integration-service', url: 'http://integration-service/health', critical: false },
      { name: 'printer-service', url: 'http://printer-service/health', critical: false },
      { name: 'network-infrastructure', url: 'http://network-infrastructure/api/health', critical: false },
      { name: 'security-suite', url: 'http://security-suite/health', critical: false },
      { name: 'monitoring-analytics', url: 'http://monitoring-analytics/health', critical: false },
      { name: 'policy-compliance', url: 'http://policy-compliance/health', critical: false },
      { name: 'backup-disaster', url: 'http://backup-disaster/health', critical: false },
      { name: 'automation-workflows', url: 'http://automation-workflows/health', critical: false },
      { name: 'container-orchestration', url: 'http://container-orchestration/health', critical: false },
      { name: 'enterprise-integrations', url: 'http://enterprise-integrations/health', critical: false },
      { name: 'ai-intelligence', url: 'http://ai-intelligence/health', critical: false },
      { name: 'notification-service', url: 'http://notification-service/health', critical: false },
      { name: 'deployment-service', url: 'http://deployment-service/health', critical: false },
      { name: 'identity-service', url: 'http://identity-service/health', critical: false },
      { name: 'lldap', url: 'http://lldap/health', critical: false },
      { name: 'prometheus', url: 'http://prometheus/-/healthy', critical: false },
      { name: 'grafana', url: 'http://grafana/api/health', critical: false },
    ];
