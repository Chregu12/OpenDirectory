...
// Mirrors services/core/device-service/src/middleware/oidcAuth.js /
// services/core/printer-service/src/middleware/oidcAuth.js so all services
// share the same auth contract and env var names.
 ...
 * and the intentionally-public PKI discovery endpoints — root CA cert
 * download and the CRL — see src/index.js for which routes are public and
 * why).
 */
